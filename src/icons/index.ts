...
type IconComponentMapping = {[iconName in IconNames]: React.FunctionComponent<IconComponentProps>};
const IconComponentsTyped = ICON_COMPONENTS as IconComponentMapping;
export default IconComponentsTyped;
